...
def parse_opt(known=False):
    ...
    parser.add_argument("--weights", type=str, default=ROOT / "yolov11s.pt", help="initial weights path")
    parser.add_argument("--cfg", type=str, default="yolov11.yaml", help="model.yaml path")
